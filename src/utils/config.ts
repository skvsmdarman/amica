...
export const defaults = {
  ...
  pollinations_apikey: process.env.NEXT_PUBLIC_POLLINATIONS_APIKEY ?? '',
  pollinations_url: process.env.NEXT_PUBLIC_POLLINATIONS_URL ?? 'https://text.pollinations.ai/openai',
  pollinations_model: process.env.NEXT_PUBLIC_POLLINATIONS_MODEL ?? 'openai',
  tts_muted: 'false',
